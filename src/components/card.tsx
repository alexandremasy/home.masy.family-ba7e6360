...
/**
 * @deprecated Use `<Card variant="glass">` inside a `<BentoItem>`. Kept only until
 * the dashboard migrates. The old `tone` painted the whole card, and `pill` was a
 * variant — both are now expressed by `variant` + `radius`.
 */
