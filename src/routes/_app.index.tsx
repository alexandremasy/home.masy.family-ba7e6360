    ...
    <div className="space-y-4 pt-16">
      ...
      <header className="stagger space-y-8">
        ...
        <div className="grid grid-cols-2 gap-3 sm:max-w-md">
          <Tile span={1} tone="default" className="relative flex min-h-[4rem] items-center overflow-hidden !rounded-full !border-0 !bg-mustard/10 !px-5 !py-3">
...
function BirthdayTile() {
  ...
  return (
    <Tile span={1} to="/anniversaires" tone="default" className={"relative flex min-h-[4rem] items-center overflow-hidden !rounded-full !border-0 !px-5 !py-3" + (today ? " !bg-warm/10" : "")}>
