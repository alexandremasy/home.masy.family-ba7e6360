    ...
    <div className="space-y-8">
      ...
      <div className="grid-bento stagger">
        ...
        <Tile span={3} to="/tesla" tone="dark" className="relative isolate">
          <MapPinBg className="pointer-events-none absolute inset-0 h-full w-full text-background opacity-70" />
          <span className="pointer-events-none absolute inset-x-0 bottom-0 h-2/3 rounded-b-[inherit] bg-gradient-to-t from-foreground/90 via-foreground/60 to-transparent" />
          <div className="flex items-start gap-3">
