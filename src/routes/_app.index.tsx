    ...
    <div className="space-y-4 pt-16">
      ...
      <div className="grid-bento stagger">
        ...
        {activeRooms.flatMap((room) => {
          ...
          return [
            <Tile key={room.key} span={1} to={`/room/${room.key}`} className={"flex flex-col !p-4 !border-white dark:!border-white/10 !bg-card/90 backdrop-blur-md " + bureauCls}>
...
function SalonTile({ room, variant }: { room: typeof rooms[number]; variant: SalonVariant }) {
  return (
    <Tile span={2} to={`/room/${room.key}`} className="relative flex flex-col !p-4 !border-white dark:!border-white/10 !bg-card/90 backdrop-blur-md">
